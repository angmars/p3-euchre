...
TEST(test_card_suit_next_black){
...
TEST(test_card_basic_v_basic_same_rank_true1){
    Card a = Card(NINE, SPADES);
    Card b = Card(NINE, HEARTS);
    ASSERT_TRUE(Card_less(a, b, CLUBS));
}

TEST(test_card_basic_v_basic_same_rank_true2){
    Card a = Card(NINE, CLUBS);
    Card b = Card(NINE, DIAMONDS);
    ASSERT_TRUE(Card_less(a, b, SPADES));
}

TEST(test_card_basic_v_basic_same_rank_false1){
    Card a = Card(FIVE, CLUBS);
    Card b = Card(FIVE, SPADES);
    ASSERT_FALSE(Card_less(a, b, DIAMONDS));
}

TEST(test_card_basic_v_basic_same_rank_false2){
    Card a = Card(FIVE, CLUBS);
    Card b = Card(FIVE, CLUBS);
    ASSERT_FALSE(Card_less(a, b, DIAMONDS));
}
...
TEST(test_card_left_bower_v_right_bower_led){
    ...
    ASSERT_TRUE(Card_less(a, b, led, HEARTS));
}
...
TEST(test_card_trump_v_left_bower_led){
    ...
    Card b = Card(JACK, CLUBS);
    Card led = Card(TEN, DIAMONDS);
    ASSERT_TRUE(Card_less(a, b, led, CLUBS));
}
...
TEST(test_card_trump_v_trump_true_led){
    ...
    ASSERT_TRUE(Card_less(a, b, led, DIAMONDS));
}
...
TEST(test_card_trump_v_trump_false1_led){
    ...
    Card b = Card(TWO, DIAMONDS);
    Card led = Card(TEN, SPADES);
    ASSERT_FALSE(Card_less(a, b, led, DIAMONDS));
}
...
TEST(test_card_basic_v_basic_same_rank_true1_led){
    Card a = Card(NINE, SPADES);
    Card b = Card(NINE, HEARTS);
    Card led = Card(JACK, CLUBS);
    ASSERT_TRUE(Card_less(a, b, led, CLUBS));
...
TEST(test_card_basic_v_basic_same_rank_true2_led){
    Card a = Card(NINE, CLUBS);
    Card b = Card(NINE, DIAMONDS);
    Card led = Card(JACK, SPADES);
    ASSERT_TRUE(Card_less(a, b, led, SPADES));
}

TEST(test_card_basic_v_basic_same_rank_false1_led){
    Card a = Card(FIVE, CLUBS);
    Card b = Card(FIVE, SPADES);
    Card led = Card(JACK, DIAMONDS);
    ASSERT_FALSE(Card_less(a, b, led, DIAMONDS));
...
TEST(test_card_basic_v_basic_same_rank_false2_led){
    Card a = Card(FIVE, CLUBS);
    Card b = Card(FIVE, CLUBS);
    Card led = Card(JACK, DIAMONDS);
    ASSERT_FALSE(Card_less(a, b, led, DIAMONDS));
